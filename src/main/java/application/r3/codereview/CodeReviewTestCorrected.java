...
public class CodeReviewTestCorrected {

    volatile Integer totalAge = 0;
    
    // Constructor should throw IOException
    CodeReviewTestCorrected(PersonDatabase<Person> personPersonDatabase)   {
        Person[] persons = null;
        try {
...
class PersonCorrected {
    ...
    public PersonCorrected(int age, String firstName, String lastName) {
        this.age = age;
    ...
    public boolean equals(Object obj) {
        return this.lastName == ((PersonCorrected)obj).lastName;
